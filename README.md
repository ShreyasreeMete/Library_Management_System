...
Member age; must be 18 or above
...
Run the SQL script in MySQL Workbench or your preferred MySQL client.
...
Execute the queries to explore the tables and sample data.
